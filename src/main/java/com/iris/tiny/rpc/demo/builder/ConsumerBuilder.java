...
import com.iris.tiny.rpc.async.ResponseFuture;
import com.iris.tiny.rpc.context.RpcContext;
import com.iris.tiny.rpc.demo.service.*;
...
public class ConsumerBuilder {
    ...
    @Test
    public void testByIris() throws Exception{

        RaceServiceListener listener = new RaceServiceListener();
        consumer.asynCall("getDO", listener);
        RaceDO nullDo = apiService.getDO();
        RaceServiceListener listener1 = new RaceServiceListener();
        consumer.asynCall("getDO", listener1);
        RaceDO nullDo1 = apiService.getDO();
    ...
    private static Class<?> getConsumerImplClass(){
        try {
            return Class.forName("com.iris.tiny.rpc.api.impl.RpcConsumerImpl");
